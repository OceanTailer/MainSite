...
<script type="text/javascript"> 
	...
	function load_sub_category(id)
	{
		...
		$.post('<?php echo base_url()?>category/detail',{id:sel_category,view_type:'image'},function(result){
	...
	{
		$.post('<?php echo base_url()?>category/delete',{cat:cat_id,level:sel_del_level,type:'deleteAll'},function(result){
			window.location.reload();
		});
	}
