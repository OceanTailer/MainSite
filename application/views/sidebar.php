...
<div class='sidebar-min-violet cleafix'>
	<div class='inner pad clearfix'>
		<input type='text' value="<?php if(isset($search_price_from)){echo $search_price_from;}else{ ?>From<?php }?>" onblur="if(this.value=='') this.value='From';" onfocus="if(this.value=='From') this.value='';" id='price-from' class='text-format-small smallest fl' />
		<input type='text' value="<?php if(isset($search_price_to)){echo $search_price_to;}else{ ?>To<?php }?>" onblur="if(this.value=='') this.value='To';" onfocus="if(this.value=='To') this.value='';" id='price-to' class='text-format-small smallest fl' />
